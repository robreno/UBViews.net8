...
public partial class XmlAppSettingsViewModel : BaseViewModel
{
    ...
    #region Public Observable Properties and RelayCommands
    [ObservableProperty]
    bool isRefreshing;
    ...
    #region Public RelayCommands
    [RelayCommand]
    async Task SettingPageAppearing()
    {
        string _method = "SettingPageAppearing";
        try
        {
    ...
    [RelayCommand]
    async Task SettingPageLoaded()
    {
        string _method = "SettingPageLoaded";
        try
        {
            // Do nothing for now
        }
    ...
    [RelayCommand]
    async Task SettingPageDisappearing()
    {
        string _method = "SettingPageDisappearing";
        try
        {
    ...
    {
        string _method = "LoadSettingsAsync";
        try
        {
