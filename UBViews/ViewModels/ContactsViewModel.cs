...
// https://stackoverflow.com/questions/72661068/net-maui-mvvm-binding-a-selecteditemcommand-and-selecteditemparameter-from-a-co
...
public partial class ContactsViewModel : ObservableValidator
{
    ...
    [RelayCommand]
    async Task FirstNameTextChanged(string value)
    {
        string _method = "FirstNameTextChanged";
    ...
    [RelayCommand]
    async Task FirstNameEntryCompleted(string value)
    {
        string _method = "FirstNameEntryCompleted";
    ...
    [RelayCommand]
    async Task LastNameTextChanged(string value)
    {
        string _method = "LastNameTextChanged";
    ...
    [RelayCommand]
    async Task LastNameEntryCompleted(string value)
    {
        string _method = "FirstNameEntryCompleted";
